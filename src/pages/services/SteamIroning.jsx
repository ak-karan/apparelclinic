...
export default function SteamIroning() {
  return (
    <ServicePageTemplate
      seoTitle="Steam Ironing Service — Professional Press at ₹15/piece Faridabad"
      seoDesc="Professional steam ironing service in Faridabad. ₹15/piece. Industrial steam press for crisp, wrinkle-free finish on all garments."
      ...
      description="Our industrial steam pressing service delivers a crisp, professional finish on every garment at just ₹15/piece. Steam (not dry heat) nourishes fabric fibres instead of scorching them."
      ...
      highlights={[
        ...
        { icon:"💰", title:"Just ₹15/Piece", desc:"Most affordable professional pressing in Faridabad" },
      ]}
      processSteps={[
